...
minerals and their public associations. It produces verified raw, Brotli, and
gzip representations so the static origin can negotiate compact transfer
without changing the manifest's decoded-byte contract. It assembles an entirely fresh sibling
