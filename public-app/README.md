...
- enable transparent Brotli or gzip content encoding for `.sqlite3` when the host supports it; `fetch()` supplies the decoded bytes that the manifest size and SHA-256 checks verify;
